    ...
    <div>
        ...
        <div class="container-fluid">
            ...
            <div class="row justify-content-center">
                <div>
                    <form action="../php/registerUser.php" class="form-group" method="post">
                        <input type="text" name="user_name" placeholder="Nome de Usuário" class="form-control" required><br />
                        <input type="date" name="age" class="form-control" required><br />
                        ...
                        <center>
                            <input type="submit" value="criar" class="btn" style='background-color: #4f4f4f; color: #C7C7C7;'>
                        </center>
                    </form>
                </div>
            </div>
