...
<head>
    ...
    if (!isset($_SESSION['loged'])) {
        echo "<script>alert('Precisa estar logado');</script>";
    ...
    <div>
        ...
        <div class="container-fluid">
            ...
            <div class="row justify-content-center">
                <form action="../php/registerPost.php" class="form-group" method="post">
                    ...
                    <center>
                        <input type="submit" value="Enviar" class="btn" style='background-color: #4f4f4f; color: #C7C7C7;'>
                    </center>
                </form>
            </div>
            <div>
